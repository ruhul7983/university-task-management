...
export default function Home() {
  ...
  useEffect(() => {
    ...
    axios.get(`http://localhost:5000/in-classroom?email=${session?.user?.email}`)
      .then((response) => {
  ...
  const events = [
    { eventName: "Quiz 1", courseName: "Software Engineering", courseCode: "CSE222", date: "12-03-2025", daysLeft: 3 },
    { eventName: "Mid Term", courseName: "IOT", courseCode: "CSE222", date: "15-03-2025", daysLeft: 6 },
    { eventName: "Project Submission", courseName: "System Analysis", courseCode: "CSE222", date: "20-03-2025", daysLeft: 11 },
    { eventName: "Final Presentation", courseName: "Software Engineering", courseCode: "CSE222", date: "25-03-2025", daysLeft: 16 },
  ];
